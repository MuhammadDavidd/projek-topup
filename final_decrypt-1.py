        ...
        if response != '':
                ...
                if parser['code'] == 401:
                        ...
                        if "apiError" in str(backend_data):
                                ...
                                #print(f"{uang}")
                                ketik(f"{red}╔═══════════════\033[1;33;41m • \033[1;37[ 𝙸𝙽𝙵𝙾 𝙰𝙺𝚄𝙽 \033[1;33m• \033[0m\033[{white}═════════════════╗")
                                ketik(f"{red} {white} - 💰 Total Uangmu: {green}{uang}   {white}                    ")
                                ketik(f"{red} {white} - 🗑️ MengurasUB: {green}{-500.000}                        {white}     ")
                                ketik(f"{white}╚═════════════════════ - {red}════════════════════════╝")
...
ketik(f"\033[1;33;41m • \033[1;37m              ❏ INJECT MONEY BUSSID BY UNKNOWN ❏                 \033[1;33m• \033[0m\033[")
ketik(f"\033[0;35m{yellow}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
ketik(f"""   {red} - 𝗣𝗲𝗺𝗯𝘂𝗮𝘁 {white}UNKNOWN          {red}  - 𝗬𝗼𝘂𝗧𝘂𝗯𝗲 {white} UNKNOWN """)
ketik(f"""   {red} - 𝗦𝗰𝗿𝗶𝗽𝘁 {white}BUSSID       {red}       - 𝙑𝙚𝙧𝙨𝙞𝙤𝙣 {white} 1.0 BETA """)
ketik(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
