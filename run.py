...
ketik(f"\033[1;33;41m â¢ \033[1;37m              == SCRIPT INJECT MONEY BUSSID BY DAPXPLOIT ==                \033[1;33mâ¢ \033[0m\033[")
ketik(f"\033[0;35m{yellow}â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬")
ketik(f"""   {red} - ð£ð²ðºð¯ðð®ð {white}DAPXPLOIT         {red}  - ð¬ð¼ðð§ðð¯ð² {white} DAPXPLOIT """)
ketik(f"""   {red} - ð¦ð°ð¿ð¶ð½ð {white}BUSSID       {red}       - ððð§ð¨ðð¤ð£ {white} 0.1.1-Release """)
