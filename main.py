...
logo = f"\n{p}╔═════════════════════════════════════╗\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 0: {w}UP TO 2.000.000          {p}║\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 1: {w}UP TO 1.000.000          {p}║\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 2: {w}UP TO 800.000            {p} ║\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 3: {w}UP TO 500.000         {p}  ║\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 4: {w}KURANGI SALDO 500.000      {p}  ║\n╚═════════════════════════════════════╝{a}"
...
auth = input(f"\033[1;33;41m•\033[1;37[Silahkan Masukkan X-Authorization Code\033[1;33m•\033[0m\033[")
        ...
        if response != '':
                ...
                if parser['code'] == 401:
                        ...
                        if "apiError" in str(backend_data):
                                ...
                                ketik(f"{red} {white} - 💰 Jumlah Uangmu: {green}{money}   {white}                    ")
                                ketik(f"{red} {white} - 🆔 ID Penggunamu: {green}{saa}               {white}     ")
                                ketik(f"{white}╚═════════════════════ - {red}════════════════════════╝")
        ...
        if response != '':
                ...
                if parser['code'] == 401:
                        ...
                        if "apiError" in str(backend_data):
                                ...
                                #print(f"{uang}")
                                ketik(f"{red}╔═══════════════\033[1;33;41m • \033[1;37[ 𝙸𝙽𝙵𝙾 𝙰𝙺𝚄𝙽 \033[1;33m• \033[0m\033[{white}═════════════════╗")
                                ketik(f"{red} {white} - 💰 Jumlah Uang Saat ini: {green}{uang}   {white}                    ")
                                ketik(f"{red} {white} - 🔄 Jumlah Dikurangi: {green}{-500.000}                        {white}     ")
                                ketik(f"{white}╚═════════════════════ - {red}════════════════════════╝")
...
def ngopi():
    for i in range(jum):
             ...
             #print(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
            # print(f"\033[1;33;41m • \033[1;37m              ❏ INJECT MONEY BUSSID BY DAPCODE  ❏                 \033[1;33m• \033[0m\033[")
            # print(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
             #print(f"""   {red} - Pembuat {white}dappkanaeruu         {red}  - Versi Bussid {white} 3.6.1 """)
           #  print(f"""   {red} - Github {white}github.com/MuhammaddDavidd       {red}      - Versi Kode {white} Dapnusantara  1.1.0""")
           #  print(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
...
def ngopii():
  #  os.system("cls||clear")
    for i in range(haya):
             ...
             #print(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
            # print(f"\033[1;33;41m • \033[1;37m              ❏ INJECT MONEY BUSSID BY UNKNOWN  ❏                 \033[1;33m• \033[0m\033[")
            # print(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
             #print(f"""   {red} - 𝗣𝗲𝗺𝗯𝘂𝗮𝘁 {white}UNKNOWN          {red}  - 𝗬𝗼𝘂𝗧𝘂𝗯𝗲 {white} UNKNOWN """)
           #  print(f"""   {red} - 𝗦𝗰𝗿𝗶𝗽𝘁 {white}BUSSID       {red}       - 𝙑𝙚𝙧𝙨𝙞𝙤𝙣 {white} 1.0 BETA """)
           #  print(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
...
ketik(f"\033[1;33;41m • \033[1;37m              ❏ ɪɴᴊᴇᴄᴛ ᴜᴀɴɢ ʙᴜssɪᴅ ʙʏ ᴅᴀᴘᴄᴏᴅᴇ ❏                 \033[1;33m• \033[0m\033[")
ketik(f"\033[0;35m{yellow}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
ketik(f"""   {red} - ᴘᴇᴍʙᴜᴀᴛ sᴄ {white} dappkanaeruu         {red}  - ɢɪᴛʜᴜʙ {white} MuhammaddDavidd """)
ketik(f"""   {red} - ᴅᴏɴᴀsɪ {white}https://s.id/DapDonasi      {red}       - ᴠᴇʀsɪ sᴄʀɪᴘᴛ {white} dapcode-1.1.0 """)
ketik(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
ketik(f"""   \33[0;31m𝗠𝗢𝗢𝗡:\33[0;32m{kal:%B            } \33[0;31m𝗗𝗔𝗬:\33[0;32m{kal:%A               }\33[0;31m 𝗧𝗚𝗟:\33[0;32m{kal:%d}""")
ketik(f"\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
def warning():
    exit(f"{p}[{y}!{p}] {y} ‼️ DATA AKUN BUSSID ANDA GAGAL DIMUAT!{a}")
def mxx():
        data = json.dumps({"PlayFabId":None,"InfoRequestParameters":{"GetUserAccountInfo":True,"GetUserInventory":True,"GetUserVirtualCurrency":True,"GetUserData":False,"UserDataKeys":None,"GetUserReadOnlyData":True,"UserReadOnlyDataKeys":None,"GetCharacterInventories":False,"GetCharacterList":False,"GetTitleData":True,"TitleDataKeys":None,"GetPlayerStatistics":False,"PlayerStatisticNames":None}})
        response = requests.post('https://4ae9.playfabapi.com/Client/GetPlayerCombinedInfo', headers=headers, data=data).text
        if response != '':
                ...
                if parser['code'] == 401:
                        ...
                        if "apiError" in str(backend_data):
                                ...
                                id= gcc['TitleInfo']
                                you= id['DisplayName']
                                ketik(f"         {blue}╔═══════════════\033[1;33;41m • \033[1;37[ INFORMASI AKUN\033[1;33m• \033[0m\033[{blue}═════════════════╗")
                                ketik(f"         {white} - 💵 Jumlah Uangmu  : {green}{money}        ")
                                ketik(f"         {white} - 🪪 Nama Akunmu     : {green}{you}")
                                ketik(f"         {white} - 🆔 ID Penggunamu   : {green}{saa}      ")
                                ketik(f"         {blue}╚═════════════════════ - ════════════════════════╝")
...
if contoh =="1":
   ...
   ngopii()
     ...
     ketik("‼️ Gunakan fitur ini dengan bijak.")
     mampus()
