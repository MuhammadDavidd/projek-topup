...
logo = f"""
{p}┌─────────────────────────────────────────┐
│[{y}•{p}] {r}Pilihan 0: {w}UP TO 2.000.000              {p}│
│[{y}•{p}] {r}Pilihan 1: {w}UP TO 1.000.000              {p}│
│[{y}•{p}] {r}Pilihan 2: {w}UP TO 800.000                {p}│
│[{y}•{p}] {r}Pilihan 3: {w}UP TO 500.000                {p}│
│[{y}•{p}] {r}Pilihan 4: {w}KURANGI -500.000             {p}│
└─────────────────────────────────────────┘{a}
"""
...
ketik("""
     _       _    _   ____                _     _          
    | | ___ | | _(_) | __ ) _   _ ___ ___(_) __| |         
 _  | |/ _ \| |/ / | |  _ \| | | / __/ __| |/ _` |         
| |_| | (_) |   <| | | |_) | |_| \__ \__ \ | (_| |         
 \___/ \___/|_|\_\_| |____/ \__,_|___/___/_|\__,_|         
 ____              _           __  __      _       _ _     
| __ ) _   _    __| | __ _ _ __\ \/ /_ __ | | ___ (_) |_   
|  _ \| | | |  / _` |/ _` | '_ \\  /| '_ \| |/ _ \| | __|  
| |_) | |_| | | (_| | (_| | |_) /  \| |_) | | (_) | | |_ _ 
|____/ \__, |  \__,_|\__,_| .__/_/\_\ .__/|_|\___/|_|\__(_)
       |___/              |_|       |_|                           
""")
        ...
        if response != '':
                ...
                if parser['code'] == 401:
                        ...
                        if "apiError" in str(backend_data):
                                ...
                                ketik(f"{r}┌───────────────{y} • {w}INFORMASI AKUN {y}• {r}───────────────┐{a}")
                                ketik(f"{r} {w} - Total_Money: {g}{money}   {w}                    ")
                                ketik(f"{r} {w} - Id_Kamu: {g}{saa}               {w}     ")
                                ketik(f"{w}└─────────────────────── - {r}───────────────────────────────┘{a}")
        ...
        if response != '':
                ...
                if parser['code'] == 401:
                        ...
                        if "apiError" in str(backend_data):
                                ...
                                #print(f"{uang}")
                                # Garis dengan informasi akun
ketik(f"{red}┌───────────────{yellow} • {white}INFORMASI AKUN {yellow}• {red}───────────────┐{reset}")
ketik(f"{red}│ {white} - Total_Money: {green}{uang} {white}                  │{reset}")
ketik(f"{red}│ {white} - MengurasUB: {green}-500.000 {white}                  │{reset}")
ketik(f"{red}└────────────────────────────────────────────────────────────────┘{reset}")
def gxg():
...
ketik(f"\033[0;35m{y}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
ketik(f"\033[1;33;41m • \033[1;37m              ✯ INJECT MONEY BUSSID BY DAPXPLOIT ✯                 \033[1;33m• \033[0m\033[")
ketik(f"\033[0;35m{yellow}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
ketik(f"""   {red} - Pembuat{white}DAPXPLOIT          {red}  - Instagram{white} dappkanaeruu """)
ketik(f"""   {red} - Script{white}BUSSID       {red}       - Version{white} 1.0.1-Release """)
ketik(f"\033[1;35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
ketik(f"""   \33[0;31MONTH:\33[0;32m{kal:%B            } \33[0;31DAY:\33[0;32m{kal:%A               }\33[0;31DATE:\33[0;32m{kal:%d}""")
ketik(f"\033[0;35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m")
def warning():
    exit(f"{p}[{y}!{p}] {y} DATA AKUN BUSSID KAMU TIDAK DAPAT DIMUAT. SILAHKAN ULANGI ATAU GUNAKAN TOKEN BARU{a}")
def mxx():
        data = json.dumps({"PlayFabId":None,"InfoRequestParameters":{"GetUserAccountInfo":True,"GetUserInventory":True,"GetUserVirtualCurrency":True,"GetUserData":False,"UserDataKeys":None,"GetUserReadOnlyData":True,"UserReadOnlyDataKeys":None,"GetCharacterInventories":False,"GetCharacterList":False,"GetTitleData":True,"TitleDataKeys":None,"GetPlayerStatistics":False,"PlayerStatisticNames":None}})
        response = requests.post('https://4ae9.playfabapi.com/Client/GetPlayerCombinedInfo', headers=headers, data=data).text
        if response != '':
                ...
                if parser['code'] == 401:
                        ...
                        if "apiError" in str(backend_data):
                                ...
                                ketik(f"{B}╔═════════════════════════════════════════════╗")
print(f"{B}║ {Y}• 𝙸𝙽𝙹𝙴𝙲𝚃 𝙼𝙾𝙽𝙴𝚈 𝙱𝚈 𝙳𝙰𝙿𝚇𝙿𝙻𝙾𝙸𝚃 • {B}║{A}")
print(f"{B}╚═════════════════════════════════════════════╝{A}")
...
mxx()
ketik(f"{B}╔═══════════════════════════════════════════════════════════════════════════════════════╗")
print(f"{B}║{Y} • INJECT MONEY BY DAPXPLOIT • {B}║")
print(f"{B}╚═══════════════════════════════════════════════════════════════════════════════════════╝{A}")
...
contoh = input (f"""{green}\033[1;33;41mâ\033[1;37mâ  PILIH  \033[1;33mâ\033[0m\033[
{green}╰───{yellow}▶""")
...
#sc by DAPXPLOIT | © DAPXPLOIT. all right reserved.
