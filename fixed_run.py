...
logo = f"\n{p}=====================================================================================================================\n===[{y}==={p}] {r}=============== 0: {w}UP TO 2============             {p}===\n===[{y}==={p}] {r}=============== 1: {w}UP TO 1============             {p}===\n===[{y}==={p}] {r}=============== 2: {w}UP TO 800============          {p} ===\n===[{y}==={p}] {r}=============== 3: {w}UP TO 500============         {p}  ===\n===[{y}==={p}] {r}=============== 4: {w}REVERSE -500============      {p}  ===\nâ===============================================================================================================â{a}"
...
ketik(f"\033[1;33;41m === \033[1;37m              === INJECT MONEY BUSSID BY CXT4X ===                 \033[1;33m=== \033[0m\033[")
ketik(f"\033[0;35m{yellow}â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬â¬")
        ...
        if response != '':
                ...
                if parser['code'] == 401:
                        ...
                        if "apiError" in str(backend_data):
                                ...
                                ketik(f"         {blue}================================================\033[1;33;41m === \033[1;37[ ============ ============ \033[1;33m=== \033[0m\033[{blue}======================================================")
...
contoh = input (f"""{green}â­\033[1;33;41m === \033[1;37m=== PILIH ===\033[1;33m=== \033[0m\033[
